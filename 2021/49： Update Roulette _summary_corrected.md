...
• Introduces Thalia, an open-source single sign-on service for managing multiple logins
• Describes how Thalia uses rules to determine which services to authenticate for
• Explains that Thalia supports two-factor authentication and can add 2FA to services without native support
• Mentions the benefits of using a service like Thalia for streamlined login management
...
• Discussion of rebuilding infrastructure and using Linde for cloud hosting
• Linde's features and benefits, including automatic backup service and one-click deployment options
• Use case example: Milwaukee Linux users group migrating from Zoom to Jitsi on Linde
...
• Deprecation of commands in Altitude robot vacuum firmware update
...
• Recent Butters support and near-parity with ZFS in Proxmox
• Importance of taking Butters seriously due to its adoption by large companies like Facebook
• Combination of Butters and ZFS in Proxmox for reliable home servers
...
• Comparison of Jodi app on Android TV vs Infuse on Apple TV
...
• A listener's comment about a passwords.txt file being left unencrypted on the hosted's GitHub repository
...
• Recap of a previous 5,000-mile road trips from Orlando to DC and then to Denver in 2018
