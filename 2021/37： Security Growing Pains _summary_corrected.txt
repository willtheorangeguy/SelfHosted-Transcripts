...
• The speaker discusses their use of Linde as a server provider, mentioning its ease of use and customer support.
• They explain that Linde offers one-click deployments for applications like Minecraft and CSGO servers, making it simple to set up private gaming spaces.
• The speaker also talks about Linde's human-powered customer support and its history as an independently owned company founded in 2003.
• They share their experience using Linde's services for their own infrastructure and personal projects, including experimenting with different WordPress stacks.
...
• Discussion turns to back up solution for a NAS (Network-Attached Storage) device, and the challenge of backing up large amounts of data (15 terabytes)
...
• Discussion of backup solutions, including using Google Drive and duplicate for encryption and multi-cloud storage
