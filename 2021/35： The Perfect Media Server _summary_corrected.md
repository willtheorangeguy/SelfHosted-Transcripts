• Discussion of Synching server setup and performance
• Feedback from listeners about previous episodes on Synching
...
• Highlighting the need for clear, step-by-step guides for installing Ubuntu, Mergers, and other tools
...
• Comparison of True NAS and Free NAS products (Synology, QNAP, Unpaid, ZFS)
• Mergers for dynamic storage growth and flexibility
• Benefits of using Linux for media servers (open source, reliability, battle-tested)
• Discussion of Mergers vs Butters
• ZFS limitations and comparison to other file systems
• Use cases for Mergers and its benefits
• Experience with Mergers on Raspberry Pi media servers
• Comparison of Mergers, ZFS, and Snap Raid solutions
• Contributing to the self-hosted wiki using MK Docs
• Vim and search function
• MK Docs features, customization, and usability
...
• A listener is asked about Butters documentation, prompting an exchange of comments
• The conversation then shifts to discussing Linde, a cloud hosting provider, including its pricing and features
• Two listeners share their experiences with using Linde for Nextcloud setups and perfectmediaserver.com
• Discussing generating public URLs for soundboard clips
• Linde services, including object storage and load balancers
• Power line networking, including its use in scenarios where Wi-Fi is unreliable
• Personal experience with power line adapters and TP-Link AV1000s
• JT's email sharing his positive experience with using power line adapters
...
• Discussion about Power line adapters and their performance
• Comparison of Power line speeds to wired Ethernet and mesh Wi-Fi
• Sharing of listener's experience with TP-Link Power line products
• Mention of various speed tests conducted by the listener
• Discussion of the listener's preference for mesh Wi-Fi over Power line
...
• Potential benefits of using Quick Sync-enabled motherboards, specifically the AS Rock J5040 IT board, for low energy usage and NAS capabilities
• Quick Sync hardware acceleration is mentioned as looking "perfect"
• The latest AMD desktop Apus are getting idle power consumption below 10 watts
• A Ry zen 5000 processor is being considered due to its performance benefits
...
• Suggesting a mini IT Xbox with two bays to hold a large hard drive
...
• Options for scanning and digitizing handwritten family recipe books, including apps like Scan bot and Va peen 1111/Recipes
