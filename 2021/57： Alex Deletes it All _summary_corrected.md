...
• Garage freezers defrost issue
• Temperature sensor idea for monitoring fridge temperature
• Wife suggests using a temperature sensor with Home Assistant
• Installing Ankara sensors using Zigbee protocol
• Testing battery life of Ankara sensors at -17°C
...
• Troubleshooting a low-range issue with a Son off CC2531 Zigbee stick
• Repurposing existing Philips Hue bulbs as mesh repeaters for improved range
• Ordering a Con B version 2 devices as an alternative solution
...
• Setting a budget for new drives ($200 per unit) and considering factors like ZFS mirroring and Snap Raid parity requirements
...
• They speculate that the manufacturer "cheaper out" on PCIe lanes, which is a concern for server-grade motherboards
...
• Discussion of the ease of restoring from Google Drive using Proxmox and promo's Google Drive backup plugin
• Promotion of Backblaze.com for secure cloud backups.
• Restore from anywhere feature with Back blaze
...
• Review of Log Sec, a similar app to Obsidian
...
• Using Obsidian with medics and a continuous integration build system
• Connecting Obsidian to Drone CI and Gift
• Creating a self-hosted wiki using medics
• Integrating plugins in medics for linking and backlinking
• Using Obsidian as a long-term wiki solution
• Replicating the pipeline for off-grid use
• Comparing Obsidian to other note-taking apps, including Tiddly Wiki and Emacs
• Exploring the community plug-in ecosystem around Obsidian
• Discussing the pricing model and free personal use option
• Linde hosting and promotions
...
• Update on Tuna integration issues and their resolution in the new release
...
• Gratitude expressed towards site reliability engineers (Sees) who support the show
