• Discussion of the host's googling experience and its challenges
...
• Waze cameras' RTMP firmware and RTSP functionality
• Docker container "Docker Waze Bridge" to enable RTSP streaming
• Using Docker Waze Bridge with Blue Iris software
• Compatibility issues with older Waze V2 firmware
• Recent changes to Waze V3 firmware affecting compatibility
...
• Comparison to built-in PMI on motherboards, which may be a more cost-effective option
...
• Potential use cases for devices that don't have built-in PMI options
• Raspberry Pi console access
• Airflow in a server cupboard
• Temperature in an RV while recording
• Linde's cloud computing services and benefits
• Anniversary of the show going independent with support from Linde
• Features and capabilities of Linde, including S3 compatible object storage and DNS manager
• Cloud providers and multi-cloud strategies
• Linde as a cloud provider option
...
• Importance of firewalls and NAT's for network security
...
• Recommendations for specific products, such as Unify and Microfiche routers, and services like cloudfree.shop
...
• De-googling efforts: listener shares their own experience and progress
	+ Replaced G Suite with Fast mail for mail, contacts, and calendar
	+ Using Joplin for notes and docs synced with Nextcloud
	+ Switched to iPhone SE 2020 for phone, using Next DNS for DNS
	+ Using Apple Maps and OpenStreetMap's app for maps
...
• They mention Fast mail, but note it's not self-hosting
• The speaker reflects on feedback from others, including a two-year journey to implement a solution
• Maps are discussed, including Here Maps, Open Street Maps, Waze, and Magic Earth
...
• View Ranger app discussed as an alternative for hiking navigation
...
• Mention of Optimum Grey wearing Chris and the Badger merchandise
• Discussion of free donuts provided by Linde at the meetup
...
• Appreciation for Self-hosted members and Sees
