...
• Introduction to Chris, Brent, and guest Fuzzy Mist born from Linux Unplugged
...
• The host and Fuzzy Mist born discuss their shared interests and friendship in a Discord community.
• Fuzzy Mist born shares his experience owning an Ionic 5, including a long road trip and testing its rapid charging capabilities.
...
• Deploying Nextcloud ISO image for constantly updated clouding setup
...
• Z-Wave migration from ovenware to Z-Wave JS due to performance and stability issues with rebooting network
...
• Discussion of the maintainer of Z-Wave JS now working full-time for Nebulas
...
• Creating an "OK to wake" system using a Z-Wave bulb and colour changing lights to signal morning time
...
• The speaker praises Linde, a cloud hosting service, for its ease of use, fast networking, and excellent customer support.
...
• Promotion of Tail scale, a zero-config VPN, for personal use and support of the show
• Personal experience with Tail scale's customer service and philosophy on sustainable infrastructure
...
• The topic of boosting items into the show was briefly mentioned, including a character named Rubicon.
...
• Comparison of Dufy cams vs. Wise cams
• Safety concerns about autonomous lawn mowers running unsupervised
• Robot mowers with safety features discussed
• Feedback from Crash Master 18 on live format and open mower idea
• Cars P. Lend's donation of 3,690 SATs and possible reference to graphics cards
