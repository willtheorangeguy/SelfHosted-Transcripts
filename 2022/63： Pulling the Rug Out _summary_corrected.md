...
• Analyzing the implications of streaming services, catalogue content removal, and artist concerns
...
• Preamp as an alternative to Spotify, its features, and user experience
• The speaker discusses their positive experience with Plex Amp, a music player that provides tailored recommendations based on user behaviour
• Comparison of Plex Amp with Fin amp, an open-source alternative, which is considered less effective but still offers the ability to use Jellyfin as a backend server
...
• Benefits and drawbacks of using non-Google services, such as ProtonMail and Fast Mail, for email hosting
• Discussion of self-hosting and limiting exposure to Google services
• Comparison of googling options, including Lineage OS and F-Droid for Android replacement
• Criticism of Google's data mining practices
• Public safety announcement: Let's Encrypt is revoking SSL certificates
• Tail scale sponsorship and promotion of their zero-config VPN solution
...
• Overview of Pep Wave/Pep Link routers and their ability to bond multiple connections over a VPN
• Concerns about Wi-Fi range and limitations with consumer-grade Wi-Fi devices
• Review of Speedily's internet bonding capabilities, but concerns about paid plans after initial free allocation
• Hardware and software bundles for US users
• Cellular signal improvement options, including Mini devices and external antennas
...
• Mention of stat's visualization limitations for neural and efficiency cores
...
• Self-hosted website URL (self-hosted.show)
