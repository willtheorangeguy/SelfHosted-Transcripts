...
• Tim launched "100 Days of Home Lab" initiative where participants will complete a task related to home automation and self-hosting every day for 100 days
...
• Mention of home jabbing and the launch of a YouTube series "100 days of home lab"
...
• Showcased storage capacities of guests on the wiki.self-hosted.show leaderboard
• The speaker praises Linde's customer support and services
• The speaker uses Linde's cloud dashboard and S3 object storage to run Nextcloud for their network
• The speaker discusses the benefits of using Linde over other major cloud providers due to its pricing (30-50% cheaper)
...
• Comparison of using etc vs MySQL as the backend database
...
• Introduction to Git Ops and its principles for declaratively defining cluster state through Git
• Explanation of how Git Ops works, including the use of manifests and pull requests to influence cluster state
• Benefits of using Git Ops, including reproducibility and accountability of changes
• Comparison of Git Ops with other DevOps practices, such as Ansible
• Git Ops approach to Kubernetes management
• Declarative vs imperative configuration
• Benefits of Git Ops: simplicity, ease of rebuilding, and version control
• Drawbacks of Git Ops: additional process steps for minor changes
• Argo CD as a tool for implementing Git Ops
...
• Tail scale and port management in firewalls
