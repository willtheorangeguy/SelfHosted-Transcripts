...
• The speaker bought a Valve Index VR headset and is considering playing Beat Safer
...
• The Petronas project is introduced, which allows Linux computers to be used as network storage devices for gaming consoles and emulators.
...
• They also reminisce about early gaming experiences, including using NetBSD, IPA, and WINS for networking, as well as playing classic games on older computers.
• Nostalgia for old TV listings and interactive services
• Memories of playing "Where in the World is Carmen Sandi ego?" on DOS and Windows
• Discussion of low-graphics games being acceptable due to safety concerns
• Promotion of Linde cloud hosting and its features (fast, reliable, 11 data centres, customer support)
• Description of Linde's infrastructure upgrades (bare metal systems, PCIe storage) and tools (API, command line client)
• Use case for Linde in a small business or studio setting for balance of security, performance, and ownership
• Mention of backup options and automatic backups on Linde
...
• The user has a positive experience with Tale scale, using it to connect to their system through a dedicated IP address and DNS feature.
...
• Power options for the Raspberry Pi, including USB storage with Butters
...
• Setting up Jodi or similar software on a Raspberry Pi as an alternative to a set-top box
...
• Gratitude expressed for members, Sees, and sponsors (Linde and Tail scale) who support the show
