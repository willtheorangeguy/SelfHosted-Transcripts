• Josh Lasker from Red Hat joins the show
...
• Discussion about receiving a My Book drive instead of an original Easy Store drive after shucking
...
• Experiences with Napoleon and Gov smart lights integrations
• Issues with Gov's rate-limited API requests and impact on Home Assistant
...
• Introduction to Tail scale VPN technology and its features
...
• Josh's Raspberry Pi collection: 43 Pis and 8 Pi Picks
• Reasons for collecting Raspberry Pis: interest in Linux, early adoption of the platform, community support
• Experimenting with alternative devices (Litre boards) but finding the Raspberry Pi to be more suitable due to open source and community factors
...
• Alternative thermal cases (Villa rose and Geek worm) compared to others
...
• File system discussion, including Synology file system and Butters
...
• The advantages and features of using Linde for cloud infrastructure
• Comparison of Linde's performance to hyperscalers
• Availability and reliability of Linde's services (99.99% uptime)
• Alternative to hyperscalers, potential use in hybrid cloud setup
• Feedback on Orange Pi boards and the Arabian OS project
• Discussion on operating systems for Raspberry Pis, including Raspbian/Raspberry Pi OS and Arabian
...
• Authentic (Authentic) authentication system mentioned as an alternative to other solutions
• Josh's approach to authentication, using Free IPA and wiping/reinstalling when necessary
• Discussing challenges with mirroring and use of Synology
• High signal compliment from Cast Plan and Booster gram show feedback
...
• Potential issues with internet connectivity while travelling due to Starlink usage
