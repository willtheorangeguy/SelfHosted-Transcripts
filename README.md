<!-- Logo -->
<h1 align="center">
  Self Hosted Transcripts
</h1>

<!-- Copy -->
<h4 align="center">Transcripts and summaries generated from Self Hosted podcast episodes through OpenAI Whisper, Llama 3.1, and LanguageTool.</h4>

<!-- Badges -->
<div align="center">
  <!-- Issues -->
  <img alt="GitHub Issues" src="https://img.shields.io/github/issues/willtheorangeguy/SelfHosted-Transcripts">
  <!-- Pull Requests -->
  <img alt="GitHub Pull Requests" src="https://img.shields.io/github/issues-pr/willtheorangeguy/SelfHosted-Transcripts">
  <!-- Discord -->
  <img alt="Discord Server ID" src="https://img.shields.io/discord/1382526731528962088">
  <!-- Language Count -->
  <img alt="GitHub Languages" src="https://img.shields.io/github/languages/count/willtheorangeguy/SelfHosted-Transcripts">
</div>
...
**To clone and run your own copy of this website**, you'll need [Git](https://git-scm.com/downloads), [Ollama](https://ollama.com/) and a bunch of Python libraries installed on your computer. If you would rather not use Git, you can just download the code from GitHub [above](https://github.com/willtheorangeguy/SelfHosted-Transcripts/archive/refs/heads/main.zip). From your command line:

```bash
# Clone this repository
$ git clone https://github.com/willtheorangeguy/SelfHosted-Transcripts.git

# Go into the repository
$ cd SelfHosted-Transcripts
...
If support is required, please open a **[GitHub Discussion](https://github.com/willtheorangeguy/SelfHosted-Transcripts/discussions/new)** or join our **[Discord](https://discord.gg/mgbda4fesN)**.

## Contributing

Please contribute using [GitHub Flow](https://guides.github.com/introduction/flow). Create a branch, add commits, and [open a pull request](https://github.com/willtheorangeguy/SelfHosted-Transcripts/compare).
...
<table>
  <tr>
    ...
    <th align="center"><img src="https://is1-ssl.mzstatic.com/image/thumb/Podcasts115/v4/45/e6/3f/45e63f1b-bed2-da9a-e132-1409b5845e62/mza_11502462662147498611.jpg/300x300bb.webp" width="150" height="150" alt="Self Hosted"/></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><a href="https://selfhosted.show/">Web</a></td>
  </tr>
</table>
