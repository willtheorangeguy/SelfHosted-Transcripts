<!-- Logo -->
<h1 align="center">Self Hosted Transcripts</h1>
...
<div align="center">
  ...
  <img alt="License" src="https://img.shields.io/github/license/willtheorangeguy/SelfHosted-Transcripts">
</div>
...
That runs the whole pipeline end to end. It covers `2019`, `2020`, `2021`, `2022`, and 3 more.
...
Open a [GitHub Discussion](https://github.com/willtheorangeguy/SelfHosted-Transcripts/discussions/new) or file an [issue](https://github.com/willtheorangeguy/SelfHosted-Transcripts/issues/new/choose).
...
**The transcripts are not.** They are machine-generated from recordings of Self Hosted podcast episodes, and the words belong to their speakers and rights holders. See [`CONTENT_LICENSE.md`](CONTENT_LICENSE.md) before reusing any of it.
