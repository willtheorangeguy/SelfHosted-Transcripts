...
Self Hosted Podcast Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "SelfHosted-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "SelfHosted-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/SelfHosted-Transcripts/archive/refs/heads/main.zip"
    output_zip = "the_standup_transcripts.zip"
