...
- podcast
- show
pretty_name: All Self Hosted Transcripts
---

# All Self Hosted Transcripts

Complete transcripts from every episode of the Self Hosted podcast from 2019 to 2025.

Generated from [this GitHub repository](https://github.com/willtheorangeguy/SelfHosted-Transcripts).
"@
