...
• Self-hosted audiobooks and photos missing due to empty directory
...
• Upgrading from 1804 to 2004 and forgetting to reset Ganoid
• Managing tech debt and putting Ganoid configuration into Git
...
• Usefulness of tools like WIN (Docker Image Update Notifier)
• Personal preference for manual updates over automation
• Introduction to Linde as a cloud provider
• Features and benefits of using Linde, including storage management and object storage
• Pricing and customer support offered by Linde
• Linde is mentioned as a cheaper and simpler alternative to AWS, Google Cloud, or Azure
...
• Cloudfree.shop smart devices pre-flashed with Taste
• Review of the new Chromecast with Google TV
• Interface performance for streaming locally over LAN
• Compatibility with traditional Android TV apps, including Jodi and Plex
...
• Promotion of self-hosted. Show membership and SRE program
