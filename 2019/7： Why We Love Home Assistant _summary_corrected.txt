...
• The Shield (NVIDIA) set-top box is discussed, including its ability to run Jodi and Plex
...
• Economical options for smart devices over the LAN, including DIY projects like the Taken SP20
• Using a Raspberry Pi to create a man-in-the-middle situation with a Wi-Fi device
• Installing Taste firmware on the device to gain control and freedom from manufacturer's business model
