# Self Hosted Transcripts — Documentation

This archive holds machine-generated transcripts and summaries for Self Hosted podcast episodes, together with the pipeline that produces them. The pipeline runs as 4 numbered stages; `main.py` executes them in order.
