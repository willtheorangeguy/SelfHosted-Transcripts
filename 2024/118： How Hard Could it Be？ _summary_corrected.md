...
• John Seeger's role as VP at Canonical and his work with Judge and Charms
• Explanation of Judge and Charms as tools for deploying and managing infrastructure
...
• Explanation of how Judge operators are similar to Kubernetes operators
...
• Feedback on Nix from users: some think it's redundant with tools like Judge and Ansible
...
• Comparing different deployment frameworks and tools (e.g. deploys, Coming)
...
• Flake hub's role in helping manage software through Flakes
...
• Comparison between Nix, Ubuntu Core, and other immutable distros like Silver blue
• Tail scale, a service for secure remote access to devices and services
• Tail scale allows users to access Linux desktops from any device connected to their network
• It offers on-demand streaming and is designed for game streaming, making it performant
• Businesses can use Tail scale for streamlined remote access and integrate with existing authentication infrastructure
• Tail scale replaces legacy VPN infrastructure and uses ACL policies for security
• The speaker built an Epic Rome home server with impressive specs: AMD EPIC 7402 CPU, 24 cores, 48 threads, 256GB ECC memory, and multiple NVMe SSDs
...
• Case: Gligar CX4712, can hold up to 10 3.5-inch hard drives and has a pair of 5.25-inch drive bays in the front
...
• Comparison of Home Lab 15 build to an equivalent custom-built server
• Cost considerations for building a Home Lab box vs buying a pre-made one
• Evaluation of the cost-effectiveness of using refurbished or used parts
• Discussion of the importance of considering long-term usage and potential upgrades when planning a Home Lab setup
...
• Regret over not knowing about Unpaid before
...
• Sponsorship by Self-hosted.show.SRE and member boosters
